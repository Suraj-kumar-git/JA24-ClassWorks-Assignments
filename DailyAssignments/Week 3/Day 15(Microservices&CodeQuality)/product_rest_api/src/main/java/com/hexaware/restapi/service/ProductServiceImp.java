...
//		repo.deleteById(productId);
		return "Product with id: "+product.getPid()+" has been deleted...!";
	}

	@Override
	public String updateProduct(ProductDTO productDto) {
		Product product = new Product(productDto.getPid(),productDto.getPname(),productDto.getPrice());
		repo.save(product);
		return "Product has been updated to "+product;
	}
