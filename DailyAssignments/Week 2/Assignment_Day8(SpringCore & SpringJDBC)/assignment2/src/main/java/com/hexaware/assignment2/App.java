...
import com.hexaware.assignment2.config.AppConfig;
import com.hexaware.assignment2.model.Loan;
import com.hexaware.assignment2.service.IService;
import com.hexaware.assignment2.service.ServiceImpl;

/**
 * Author = JA24 Suraj Kumar
 * Date = 23 Jan 2024
 */
public class App {
    ...
    public static void main( String[] args ){
        ...
        System.out.println("Welcome to my 2nd Assignment...");
        boolean stop=false;
        ...
        while (!stop) {
			...
			case 1: {
				...
				Loan loan = readLoan();
				int count1 = service.createLoan(loan);
				if (count1==1) {
			...
			case 2:
				...
				Loan loan= readLoan();
				int count2= service.updateLoan(loan);
				if (count2==1) {
			...
			case 3:
				...
				int id = sc.nextInt();
				int count3= service.deleteLoan(id);
				if(count3==1) {
			...
			case 5:
				...
				break;
			case 6:
				System.out.println("Enter the Loan type(Home Loan/Business Loan/Personal Loan/Gold Loan/Vehicle Loan) to select:");
				sc.nextLine();
